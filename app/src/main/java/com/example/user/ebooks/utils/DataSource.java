...
public class DataSource {
    ...
    public static List<Book> getPopularBooks(){
        ...
        lstBooks.add(new Book("Letters Of AmericanLady",R.drawable.letterstoamericanlady,R.drawable.letterstoamericanlady,"I. LETTER TO AN AMERICAN:\n" +
        ...
        lstBooks.add(new Book("The Tree",R.drawable.tree,R.drawable.tree,"Freeditorial Literary Contest. Thanksgiving Day, 2015\n" +
        ...
        lstBooks.add(new Book("The Art Of War",R.drawable.war,R.drawable.war,"Twenty-Five Hundred years ago, Sun Tzu wrote this classic book of military strategy based on Chinese warfare and military thought. Since that time, all levels of military have used the teaching on Sun Tzu to warfare and cilivzation have adapted these teachings for use in politics, business and everyday life. The Art of War is a book which should be used to gain advantage of opponents in the boardroom and battlefield alike."));


        lstBooks.add(new Book("Poetry Of Art",R.drawable.poetryofart,R.drawable.poetryofart,"written poems on different topics"));

        lstBooks.add(new Book("Peter Pan",R.drawable.peterpan,R.drawable.peterpan,"Peter Pan is a fictional character created by Scottish novelist and playwright J. M. Barrie. A free-spirited and mischievous young boy who can fly and never grows up, Peter Pan spends his never-ending childhood having adventures on the mythical island of Neverland as the leader of the Lost Boys, interacting with fairies, pirates, mermaids, Native Americans, and occasionally ordinary children from the world outside Neverland."));

        lstBooks.add(new Book("Poetry Of War",R.drawable.poetryofart,R.drawable.poetryofart,"written poems on different topics"));
    ...
    public static List<Book> getLastWeekBook(){
        ...
        List<Book> lstBooks = new ArrayList<>();
        lstBooks.add(new Book("The Record",R.drawable.record,R.drawable.record,"One\n" +
        ...
        lstBooks.add(new Book("Romeo And Juliet",R.drawable.romeoandjuliet,R.drawable.romeoandjuliet,"Two households, both alike in dignity,\n" +
        ...
        lstBooks.add(new Book("Little Prince",R.drawable.the_little_prince,R.drawable.the_little_prince,"Moral allegory and spiritual autobiography, The Little Prince is the most translated book in the French language. With a timeless charm it tells the story of a little boy who leaves the safety of his own tiny planet to travel the universe, learning the vagaries of adult behaviour through a series of extraordinary encounters. His personal odyssey culminates in a voyage to Earth and further adventures."));

        lstBooks.add(new Book("Dracula",R.drawable.dracula,R.drawable.dracula,"Dracula is an 1897 Gothic horror novel by Irish author Bram Stoker. It introduced the character of Count Dracula, and established many conventions of subsequent vampire fantasy.[1] The novel tells the story of Dracula's attempt to move from Transylvania to England so that he may find new blood and spread the undead curse, and of the battle between Dracula and a small group of men and a woman led by Professor Abraham Van Helsing."));

        lstBooks.add(new Book("The Bow",R.drawable.bow,R.drawable.bow,"The Freeditorial Prizes. Thanksgiving Day, 2016\n" +
